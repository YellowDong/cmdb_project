...
def get_nic_info():
    ...
    raw_data = raw_data.stdout.read().decode('utf-8').split("\n")
    #print(raw_data)
...
def get_disk_info():
    # raw_data = subprocess.Popen("sudo hdparm -i /dev/sda", stdout=subprocess.PIPE, shell=True)
    # print(raw_data, '()()()()()()()()()()(()()()')
