...
class Asset(models.Model):
    ...
    idc = models.ForeignKey('IDC', null=True, blank=True, verbose_name='价格')
...
class Server(models.Model):
    ...
    created_by = models.CharField(choices=created_by_choice, default='auto', verbose_name='添加方式', max_length=32)
